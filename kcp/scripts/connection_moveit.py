...
class MoveGroupPythonInterface(object):    
    ...
    def __init__(self, group):
        ...
        self.table_position = [2.0, 0.0, 0.26]
    ...
    def get_position(self):
        ...
        return joint_list, cartesian_position
    ...
    def go_to_home(self):
        if self.debug_prints: print(bcolors.HEADER+"connection_moveit:"+bcolors.ENDC+" go_to_home ")
        move_group = self.move_group
        joint_goal = move_group.get_current_joint_values()   

        if self.main_positions_list[0] == self.template_position:
            print(bcolors.WARNING+"No hay un punto HOME guardado")     
        else:
            joint_goal = self.main_positions_list[0]
    ...
    def add_tool_fun(self):        
        ...
        tool_pose.pose.position.x = end_efector_position[1][0] + self.tool_dimensions[self.tool_axis]/2 # For centering
        tool_pose.pose.position.y = end_efector_position[1][1]
        tool_pose.pose.position.z = end_efector_position[1][2]
        self.tool_name = "Tool"
