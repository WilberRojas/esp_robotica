...
class Interfaz1:
    def __init__(self):
        ...
        self.group_name = rospy.get_param('/ros_smartpad/Planning_Group')
        #self.group_name = "arm"
        ...
        print(bcolors.OKGREEN+"Ready for your commands")
    ...
    def grafical_events(self, event):  #----------------------grafical_events
        ...
        if event == 'VR_mas':
            if(self.VelR_percentage == 100):
                print(bcolors.WARNING+"maxima velocidad")
            else:
            ...
            if(self.VelR_percentage < 0.1):
                print(bcolors.WARNING+"minima velocidad")
            else:
                self.VelR_percentage = self.VelR_percentage/2
                self.events.velocity(event, self.VelR_percentage)
        ...
        if event == 'start':  
            ...
            if next_index_point <= 100:                
                text_label_point = "P: "+str(next_index_point+1)
                print(bcolors.OKBLUE+ text_label_point)
                self.point_Label.config(text=text_label_point)
                self.Combo_puntos.current(next_index_point)
        ...
        if event == "update_table":
            ...
            except: print(bcolors.WARNING+"DATOS ERRONEOS: La posicion y dimension de la mesa deben ser numericos")
        ...
        if event == "update_tool":            
            ...
            try:
                ...
                self.events.advanced_functions(event, dimension_tool)
            except: print(bcolors.WARNING+"DATOS ERRONEOS: Las dimensiones de la herramienta deben ser numericos")
    ...
    def update_tool_function(self):
        ...
        tool_dim = self.events.advanced_functions("get_tool_dim")        
    ...
    def tools(self):
        ...
        self.table_update = tkinter.Button(self.ventana, text= "UPDATE", command=lambda: self.grafical_events("update_table"))
        ...
        # Position
        self.Label_Table_Positions = tkinter.Label(self.ventana, text = "Positions:", width = 10, height = 2, fg= self.Font_Color, bg= self.Color_Background)

        self.Label_Table_posX = tkinter.Label(self.ventana, text = "x", width = 10, height = 2, fg= self.Font_Color, bg= self.Color_Background)
        self.Label_Table_posY = tkinter.Label(self.ventana, text = "y", width = 10, height = 2, fg= self.Font_Color, bg= self.Color_Background)
        self.Label_Table_posZ = tkinter.Label(self.ventana, text = "z", width = 10, height = 2, fg= self.Font_Color, bg= self.Color_Background)

        self.Button_Table_posX = tkinter.Text(self.ventana, height=1, width=15)        
        self.Button_Table_posY = tkinter.Text(self.ventana, height=1, width=15)        
        self.Button_Table_posZ = tkinter.Text(self.ventana, height=1, width=15)

        self.Button_Table_posX.config(width=8)
        self.Button_Table_posY.config(width=8)
        self.Button_Table_posZ.config(width=8)
        
        # Dimensions

        self.Label_Table_Dimensions = tkinter.Label(self.ventana, text = "Dimensions:", width = 10, height = 2, fg= self.Font_Color, bg= self.Color_Background)

        self.Label_Table_dimX = tkinter.Label(self.ventana, text = "x", width = 10, height = 2, fg= self.Font_Color, bg= self.Color_Background)
        self.Label_Table_dimY = tkinter.Label(self.ventana, text = "y", width = 10, height = 2, fg= self.Font_Color, bg= self.Color_Background)
        self.Label_Table_dimZ = tkinter.Label(self.ventana, text = "z", width = 10, height = 2, fg= self.Font_Color, bg= self.Color_Background)

        self.Button_Table_dimXmas = tkinter.Text(self.ventana, height=1, width=15)
        self.Button_Table_dimYmas = tkinter.Text(self.ventana, height=1, width=15)
        self.Button_Table_dimZmas = tkinter.Text(self.ventana, height=1, width=15)
        
        self.Button_Table_dimXmas.config(width=8)
        self.Button_Table_dimYmas.config(width=8)
        self.Button_Table_dimZmas.config(width=8)
        ...
        self.tool_update = tkinter.Button(self.ventana, text= "UPDATE", command=lambda: self.grafical_events("update_tool"))

        # Dimensions

        self.Label_Tool_Dimensions = tkinter.Label(self.ventana, text = "Dimensions:", width = 10, height = 2, fg= self.Font_Color, bg= self.Color_Background)

        self.Label_Tool_dimX = tkinter.Label(self.ventana, text = "x", width = 10, height = 2, fg= self.Font_Color, bg= self.Color_Background)
        self.Label_Tool_dimY = tkinter.Label(self.ventana, text = "y", width = 10, height = 2, fg= self.Font_Color, bg= self.Color_Background)
        self.Label_Tool_dimZ = tkinter.Label(self.ventana, text = "z", width = 10, height = 2, fg= self.Font_Color, bg= self.Color_Background)

        self.Button_Tool_dimXmas = tkinter.Text(self.ventana, height=1, width=15)
        self.Button_Tool_dimYmas = tkinter.Text(self.ventana, height=1, width=15)
        self.Button_Tool_dimZmas = tkinter.Text(self.ventana, height=1, width=15)
        
        self.Button_Tool_dimXmas.config(width=8)
        self.Button_Tool_dimYmas.config(width=8)
        self.Button_Tool_dimZmas.config(width=8)
    ...
    def spawn_advanced_tool(self): #--------tools: table
        ...
        self.Label_Tool_dimX.grid_forget()
        self.Label_Tool_dimY.grid_forget()
        self.Label_Tool_dimZ.grid_forget()
    ...
    def hide_advanced_tool(self): 
        ...
        self.Label_Tool_Dimensions.grid(row=self.start_row_tools+8,column=self.start_column_tools+2, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)

        self.Label_Tool_dimX.grid(row=self.start_row_tools+9,column=self.start_column_tools+2, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)
        self.Label_Tool_dimY.grid(row=self.start_row_tools+10,column=self.start_column_tools+2, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)
        self.Label_Tool_dimZ.grid(row=self.start_row_tools+11,column=self.start_column_tools+2, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)

        self.Button_Tool_dimXmas.grid(row=self.start_row_tools+9,column=self.start_column_tools+3, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)
        self.Button_Tool_dimYmas.grid(row=self.start_row_tools+10,column=self.start_column_tools+3, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)
        self.Button_Tool_dimZmas.grid(row=self.start_row_tools+11,column=self.start_column_tools+3, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)

        self.tool_update.grid(row=self.start_row_tools+12,column=self.start_column_tools+3, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)
    ...
    def spawn_table(self): #--------tools: table
        ...
        self.Label_Table_posX.grid_forget()
        self.Label_Table_posY.grid_forget()
        self.Label_Table_posZ.grid_forget()
        ...
        self.Label_Table_dimX.grid_forget()
        self.Label_Table_dimY.grid_forget()
        self.Label_Table_dimZ.grid_forget()
    ...
    def hide_table(self):
        ...
        self.clear_button.grid(row=self.start_row_tools+7,column=self.start_column_tools, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)
        self.table_update.grid(row=self.start_row_tools+7,column=self.start_column_tools+3, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)
        ...
        self.Label_Table_posX.grid(row=self.start_row_tools+4,column=self.start_column_tools, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)
        self.Label_Table_posY.grid(row=self.start_row_tools+5,column=self.start_column_tools, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)
        self.Label_Table_posZ.grid(row=self.start_row_tools+6,column=self.start_column_tools, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)

        self.Button_Table_posX.grid(row=self.start_row_tools+4,column=self.start_column_tools+1, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)
        self.Button_Table_posY.grid(row=self.start_row_tools+5,column=self.start_column_tools+1, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)
        self.Button_Table_posZ.grid(row=self.start_row_tools+6,column=self.start_column_tools+1, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)

        # Dimensions

        self.Label_Table_Dimensions.grid(row=self.start_row_tools+3,column=self.start_column_tools+2, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)

        self.Label_Table_dimX.grid(row=self.start_row_tools+4,column=self.start_column_tools+2, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)
        self.Label_Table_dimY.grid(row=self.start_row_tools+5,column=self.start_column_tools+2, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)
        self.Label_Table_dimZ.grid(row=self.start_row_tools+6,column=self.start_column_tools+2, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)

        self.Button_Table_dimXmas.grid(row=self.start_row_tools+4,column=self.start_column_tools+3, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)
        self.Button_Table_dimYmas.grid(row=self.start_row_tools+5,column=self.start_column_tools+3, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)
        self.Button_Table_dimZmas.grid(row=self.start_row_tools+6,column=self.start_column_tools+3, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)
    ...
    def spawn_historial(self):
        ...
        self.delete_Button.grid(row=start_row+3,column=start_column+3, columnspan=3, padx=self.matrix_X, pady=self.matrix_Y)        
    ...
    def add_secuencia(self): 
        ...
        #self.export_name.insert(tkinter.INSERT, self.group_name+ str(datetime.today().strftime('-%d_%m_%Y')))
